...
@section('content')
    <div class="container px-6 py-4 mx-auto">
        <h3 class="text-xl font-medium text-gray-700">Pengaturan User</h3>

        <div class="my-3 border border-gray-200 rounded-md shadow-md p-2 bg-white">
            <div class="bg-white">
                <button type="button" data-modal-target="new-user-modal" data-modal-toggle="new-user-modal"
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr class="text-gray-700 text-sm">
                            ...
                            <td
                                class="border-r border-b border-gray-300 text-center {{ $user->status === 1 ? 'text-green-500' : 'text-red-500' }}">
                            ...
                            <td class="border-r border-b border-gray-300 flex items-center justify-center gap-2">
                                <a href="#" data-id="{{ $user->id }}" data-name="{{ $user->name }}"
                                    ...
                                    data-unit="{{ $user->unit }}" data-status="{{ $user->status }}"
                                    class="btn-edit bg-blue-500 hover:opacity-75 px-2 py-1 text-sm rounded-md shadow-sm text-white">Edit</a>
                                <a href=""
                                    class="bg-red-500 hover:opacity-75 px-2 py-1 text-sm rounded-md shadow-sm text-white">Disable</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    <div id="new-user-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full md:w-8/12 max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <!-- Modal body -->
                <form id="new-user-form" class="p-4 md:p-5 shadow-md rounded-md"
                    action="{{ route('admin.pengaturan.user') }}" method="POST">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="">
                            ...
                            <input type="email" name="email" id="email"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                placeholder="Input email user" required="">
                        </div>
                        <div class="">
                        ...
                        <div class="">
                            <label for="konf_password" class="block mb-2 text-sm font-medium text-gray-900">Konfirmasi
                                Password</label>
                            <input type="password" name="konf_password" id="konf_password"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                    ...
                    <button type="button" onclick="confirmSubmitUser()"
    ...
    <div id="edit-user-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full md:w-8/12 max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <!-- Modal body -->
                <form id="edit-user-form" class="p-4 md:p-5 shadow-md rounded-md"
                    action="{{ route('admin.pengaturan.user.update') }}" method="POST">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="">
                        ...
                        <div class="">
                            ...
                            <input type="email" name="email" id="edit_email"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                placeholder="Input email user" readonly>
                        </div>
                        <div class="">
                    ...
                    <button type="button" onclick="confirmUpdateUser()"
                        class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                        <svg class="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
