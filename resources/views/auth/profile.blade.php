            ...
            @csrf
                <div class="grid grid-cols-2 gap-3">
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" value="{{ $user->name }}" placeholder="Nama user"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="email" name="email" id="email" value="{{ $user->email }}" placeholder="admin@mail.com"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-3">
                    <div class="mb-5">
                        ...
                        <select id="role" name="role" value="{{ $user->role }}"
                            class="rounded-md border border-[#e0e0e0] bg-white py-3 px-6 w-full text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" required>
