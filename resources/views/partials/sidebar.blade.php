    ...
    <nav class="mt-4">
        ...
        <div x-data="{ menuStatusOpen: false }" class="relative">
            ...
            <div x-cloak x-show="menuStatusOpen" @click.away="menuStatusOpen = false"
                class="origin-top-right mt-2 w-full rounded-md shadow-lg focus:outline-none"
                role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                <div class="pl-12 pr-2">
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Dalam Antrian</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Proses Pengecekan</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Menunggu Konfirmasi</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Proses Pengerjaan</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Selesai Dikerjakan</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Dibatalkan</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Riwayat Perbaikan</a>
                </div>
            </div>
            <!-- Submenu -->
        </div>
        ...
        <div x-data="{ menuDeliveryOpen: false }" class="relative">
            ...
            <div x-cloak x-show="menuDeliveryOpen" @click.away="menuDeliveryOpen = false"
                ...
                role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                <div class="pl-12 pr-2">
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Jadwal</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Sedang Berlangsung</a>
                    <a href="#" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Riwayat</a>
                </div>
            </div>
            <!-- Submenu -->
        </div>
        ...
        <div x-data="{ menuSettingOpen: false }" class="relative">
            ...
            <div x-cloak x-show="menuSettingOpen" @click.away="menuSettingOpen = false"
                ...
                role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                <div class="pl-12 pr-2">
                    <a href="{{ route('admin.pengaturan.user') }}" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">User</a>
                    <a href="{{ route('admin.pengaturan.role') }}" class="flex items-center px-2 py-2 text-gray-500 text-md hover:bg-gray-600 hover:text-gray-900 rounded-md" role="menuitem">Roles</a>
                </div>
            </div>
            <!-- Submenu -->
        </div>
